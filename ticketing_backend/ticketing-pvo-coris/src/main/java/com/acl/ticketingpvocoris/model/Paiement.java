...
public class Paiement implements Serializable {
    ...
    public Paiement(String codeTicket, String reference,double montant ,
                    String operateur,User user, String telephone,
                    TypePaiement typePaiement,String transactionId, Date dateExpiration,
                    Date createdAt){
