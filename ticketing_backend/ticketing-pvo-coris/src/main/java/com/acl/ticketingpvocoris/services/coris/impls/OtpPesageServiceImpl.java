...
/**
 * @author kol on 12/11/24
 * @project microservice
 */
@Service
@Slf4j
public class OtpPesageServiceImpl implements OtpPesageService {
    ...
    public OtpPesageServiceImpl(UtilService utilService, TypePrestationRepository typePrestationRepository, PaiementRepository paiementRepository, UserRepository userRepository, PrestationRepository prestationRepository) {
    ...
    @Override
    public ResponseEntity<?> checkCodeOtp(UserPrincipal currentUser,
                                          PaiementRequestOtp request) throws Exception {
    ...
    private ResponseEntity<?> verifyOtpAndPaiement(PaiementRequestOtp paiementRequestOtp,
        ...
        HttpUriRequest requests = RequestBuilder.post()
                .setUri(url + "paiement-bien?codePays=" +paiementRequestOtp.getCountryCode()
                        ...
                        +"&montant="+ paiementRequestOtp.getMontant()
